/**
    Description   : Master trigger for the "NGS Technician" object (NGS_Technician__c)
...
*/
trigger NGS_Technician_Trigger on NGS_Technician__c (before insert, before update, 
    ...
    if (System.Label.NGS_Bypass_Mass_Transfer_Records == 'FALSE'){
        ...
        NGS_Technician_TriggerHandler handler = new NGS_Technician_TriggerHandler();
